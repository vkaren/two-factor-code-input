...
TwoFactorCodeInput.prototype.onEnterDigit = function ({ currentInput, currentInputPosition, enteredDigit, nextInput, }) {
    if (nextInput) {
...
TwoFactorCodeInput.prototype.onBackspacePressed = function ({ currentInput, currentInputPosition, prevInput, }) {
    if (!this.isDeleting) {
...
TwoFactorCodeInput.prototype.getValidCode = function () {
    ...
    const validCode = Math.floor(Math.random() * (maxValidCode - minValidCode + 1)) +
        minValidCode;
    return validCode;
};
